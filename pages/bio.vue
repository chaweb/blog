...
.content
  ...
  p Aujourd'hui, et ce site en fait, j'utilise Nuxt.js avec Pug et Sass (un peu de terme technique si vous ne connaissez pas bien le millieu, sowwy). 
    | Et donc, c'est aussi pour m'entrainer, m'excercer et taffer sur un site.     
  ...
  p Ce blog contiendra un peu de tout. Allant du tuto "comment faire tel chose" à, si je me sens assez à l'aise, juste des critique  
    | contre la société ou des personnes polytiques, ou même des histoires oneshot relier à mon univer original.
  ...
  p Je tiens à préciser que même si j'aime ce que j'écris, certaine chose peut être fausse... Donc, dans ce que je dis 
    | -Et j'espère que vous le faites déjà- ne prenez au pied de la lettre. Soyez critique. 
