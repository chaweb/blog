<template lang="pug">
.content
    h3 1 - création filière technologique "création numérique"
    ul
        li mathématiques
        li spécialité
            ul
    ...
    ul
        li 5 ou + attestion sur l'honneur de proche utilisant le prénom d'usage
        li attestion médical (psychologue ou psychiatre, ect...)
